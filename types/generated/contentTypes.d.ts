...
export interface ApiFeedbackCampaignFeedbackCampaign
  extends Struct.CollectionTypeSchema {
  collectionName: 'feedback-campaigns';
  info: {
    displayName: 'Feedback Campaign';
    pluralName: 'feedback-campaigns';
    singularName: 'feedback-campaign';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feedback-campaign.feedback-campaign'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFeedbackFeedback extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feedback_campaign: Schema.Attribute.Relation<
      'manyToOne',
      'api::feedback-campaign.feedback-campaign'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::feedback-campaign.feedback-campaign': ApiFeedbackCampaignFeedbackCampaign;
